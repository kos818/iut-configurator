...
export const componentTemplates: ComponentTemplate[] = [
  ...
  {
    type: 'tee_reducing_equal',
    name: 'FFQ-Stück gleichschenklig',
    description: 'T-Stück reduziert gleichschenklig',
    group: 'branches',
    defaultDN: 50,
    defaultWallThickness: 3,
    availableWallThicknesses: [2, 2.5, 3, 4, 5, 6],
  ...
  {
    type: 'tee_reducing_unequal',
    name: 'FFQ-Stück ungleichschenklig',
    description: 'T-Stück reduziert ungleichschenklig',
    group: 'branches',
    defaultDN: 50,
    defaultWallThickness: 3,
    availableWallThicknesses: [2, 2.5, 3, 4, 5, 6],
